...
\mynames{Dinh-Xuan/H.\bibnamedelimi,
         Dinh-Xuan/Hung,
         Dinh-Xuan/Hung\bibnamedelima D.}
...
\leftheader{%
  ...
  {\LARGE\bfseries\sffamily Dinh Xuan Hung}

  \makefield{\faEnvelope[regular]}{\href{mailto:hungdx@soongsil.ac.kr}{\texttt{hungdx@soongsil.ac.kr}}}
  ...
  {\href{http://www.linkedin.com/in/hung-dinh-xuan/}{\texttt{hung-dinh-xuan}}}
  \makefield{\faGithub}
  {\href{https://github.com/hungdinhxuan}{\texttt{hungdinhxuan}}}
  \makefield{\faGraduationCap}
  {\href{https://scholar.google.com/citations?user=GqijLfkAAAAJ}{\texttt{Google Scholar}}}

  %% Next line
  \makefield{\faGlobe}{\url{https://hungdx.com/}}
  % You can use a tabular here if you want to line up the fields.
  % \makefield{\faEnvelope[\href{}{}]}
  %\makefield{{\faIcon{phone}}}{\!\href{tel:+821057193956}{+821057193956}}
